...
docker version
# You can get information about docker with the command docker information
docker info
...
#DOCEKR PS docker ps - list all running containers
docker ps
...
docker rm 1he -f # delete running container, by default you should stop it first
...
# DOCKER LOGS
# You can get logs of the container with the docker logs command
docker logs container_id
# You can attach to logs with the flag -first
